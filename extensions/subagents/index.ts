...
const CUSTOM_TOOL_EXTENSIONS: Record<string, string> = {
	// Local Pi harness web tools use crawl4ai-search.ts and register `search`/`scrape`.
	search: path.join(EXT_BASE, "crawl4ai-search.ts"),
	scrape: path.join(EXT_BASE, "crawl4ai-search.ts"),
	// Back-compat if an agent prompt still asks for the upstream names.
	web_search: path.join(EXT_BASE, "crawl4ai-search.ts"),
	web_fetch: path.join(EXT_BASE, "crawl4ai-search.ts"),
